...
class S826(object):
    def __init__(self):
        ...
        self.lowerV_2 = [-10,-10,-10,-10,-10,-10,-10,-10]  # default range selection = 0
        self.rangeV_2 = [20,20,20,20,20,20,20,20]  # default range selection = 0
    ...
    def s826_initAdc(self):
        ...
        s826dll.S826_AdcSlotlistWrite(BOARD, 0xFFFF, 0) # enable all ADC timeslots
        s826dll.S826_AdcTrigModeWrite(BOARD, 0) # disable ADC hardware triggering, use continuous mode
        s826dll.S826_AdcEnableWrite(BOARD, 1) # enable ADC conversions
    ...
    def s826_setAdcRange(self,chan,rangeCode):
        ...
        s826dll.S826_AdcSlotConfigWrite(BOARD,chan,chan,TSETTLE,rangeCode) # BOARD, timeslot, chan, tsettle, range
