...
class CustomFigCanvas(FigureCanvas, TimedAnimation):
    ...
    def __init__(self):
        ...
        self.ax2.add_line(self.line21)
        self.ax2.add_line(self.line21_tail)
        self.ax2.add_line(self.line21_head)
        # line2 in plot 2
        ...
        self.ax2.add_line(self.line22)
        self.ax2.add_line(self.line22_tail)
        self.ax2.add_line(self.line22_head)
        # line3 in plot 2
        ...
        self.ax2.add_line(self.line23)
        self.ax2.add_line(self.line23_tail)
        self.ax2.add_line(self.line23_head)
        # line4 in plot 2
        self.line24 = Line2D([], [], color='tab:orange')
        self.line24_tail = Line2D([], [], color='tab:orange', linewidth=2)
        self.line24_head = Line2D([], [], color='tab:orange', marker='o', markeredgecolor='tab:orange')
        self.ax2.add_line(self.line24)
        self.ax2.add_line(self.line24_tail)
        self.ax2.add_line(self.line24_head)
        # line5 in plot 2
        self.line25 = Line2D([], [], color='tab:purple')
        self.line25_tail = Line2D([], [], color='tab:purple', linewidth=2)
        self.line25_head = Line2D([], [], color='tab:purple', marker='o', markeredgecolor='tab:purple')
        self.ax2.add_line(self.line25)
        self.ax2.add_line(self.line25_tail)
        self.ax2.add_line(self.line25_head)
        # line6 in plot 2
        self.line26 = Line2D([], [], color='tab:brown')
        self.line26_tail = Line2D([], [], color='tab:brown', linewidth=2)
        self.line26_head = Line2D([], [], color='tab:brown', marker='o', markeredgecolor='tab:brown')
        self.ax2.add_line(self.line26)
        self.ax2.add_line(self.line26_tail)
        self.ax2.add_line(self.line26_head)
        # line7 in plot 2
        self.line27 = Line2D([], [], color='tab:olive')
        self.line27_tail = Line2D([], [], color='tab:olive', linewidth=2)
        self.line27_head = Line2D([], [], color='tab:olive', marker='o', markeredgecolor='tab:olive')
        self.ax2.add_line(self.line27)
        self.ax2.add_line(self.line27_tail)
        self.ax2.add_line(self.line27_head)
        # line8 in plot 2
        self.line28 = Line2D([], [], color='tab:cyan')
        self.line28_tail = Line2D([], [], color='tab:cyan', linewidth=2)
        self.line28_head = Line2D([], [], color='tab:cyan', marker='o', markeredgecolor='tab:cyan')
        self.ax2.add_line(self.line28)
        self.ax2.add_line(self.line28_tail)
        self.ax2.add_line(self.line28_head)
        #lim
